...
<div className="space-y-4 text-zinc-100/90 leading-relaxed text-[16px] md:text-[17px]">
  <p>
    ...
    во мне что-то переключилось, будто счелкнуло выключателем. Однажды ночью просто села и написала стих, будто всегда это делала.
  ...
  <p>
    ...
    она всегда была рядом и всегда восхищалась ммой.
